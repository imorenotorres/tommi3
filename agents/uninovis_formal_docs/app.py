"""
Uninovis Formal Docs - Servidor FastAPI (RAG)
"""
...
AGENT_CONFIG = {
    "id": "uninovis_formal_docs",
    "name": "Uninovis Formal Docs",
    "type": "rag",
    "description": "This agent can provide information about UNINIOVIS governance documents",
    "welcome_message": "Hello! I'm Uninovis Formal Docs. How can I help you?",
    "example_queries": ["Describe the Governance bodies of UNINOVIS", "Who owns the results in UNINOVIS?", "How is the chair of the Board of Presidents decided?"]
}
