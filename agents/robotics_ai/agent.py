...
2. Compare them against well-known {research_topic} subtopics (e.g., algorithmic auditing, AI safety, data sovereignty, human-AI interaction, AI and disability, AI and environmental impact, AI red-teaming, adversarial robustness, AI supply chain ethics, etc.).
...
<body>
    ...
    def _cites_database_sources(text: str) -> bool:
        ...
        indicators = [
            r'📄', r'PDF', r'Title:', r'Author:', r'DOI',
