...
_PALABRAS_RAW = [
    ...
    ("cuadros", "'kua.dɾos"),              # diptongo + at.complejo + coda
    ...
    ("huevo", "'ue.bo"),                   # diptongo + AFI(h→Ø, v→b)
    ("hielo", "'ʝe.lo"),                   # hie- inicial → /ʝ/ + AFI(h→ʝ)
    ("hierba", "'ʝeɾ.ba"),                 # hie- inicial → /ʝ/ + coda + AFI(h→ʝ, v→b)
    ("hierro", "'ʝe.ro"),                  # hie- inicial → /ʝ/ + AFI(h→ʝ, rr→r)
    ("hiena", "'ʝe.na"),                   # hie- inicial → /ʝ/ + AFI(h→ʝ)
    ("huérfano", "'ueɾ.fa.no"),            # diptongo + coda + AFI(h→Ø)
    ("viernes", "'bieɾ.nes"),              # diptongo + 2 codas + AFI(v→b)
    ("aunque", "'aun.ke"),                 # diptongo + coda + AFI(qu→k)
