...
### 5.3 Construction Trajectory
  ...
  ---------------------------- ------------------------------------- -------------------------------------
  Initial accuracy (Phase A)   79.7%                                 95.7%

  Iterations to 100%           3                                     3

  Final dev-set accuracy       100% (69/69)                          100% (69/69)

  Types of fixes               Regex patterns, priority reordering   Prompt descriptions, boundary rules
  --------------------------------------------------------------------------------------------------------

Additionally, a hand-crafted rule-based variant developed over several months of production use is included as a reference point. This variant uses \~50 manually designed synonym mappings and a 13-step classification chain.
