...
- topic_search vs papers: If a query mentions a TOPIC (e.g. "AI in education", "AI ethics"), use topic_search — even if it also mentions a university or "UNINOVIS". Use papers ONLY when asking for ALL papers/researchers from a university without specifying a topic (e.g. "List all papers from UDCLV", "Who are the researchers at THUAS?").
