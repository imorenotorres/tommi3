"""
Benchmark 100 queries for the Responsible AI Agent.
...
BANNER_GREEN = "green"    # Verified data (metadata, glossary, figures)
BANNER_YELLOW = "yellow"  # AI interpretation of database content
BANNER_RED = "red"        # Unverified / off-topic / speculation
...
BENCHMARK_QUERIES = [
    ...
    {"id": "S01", "profile": "Students", "subcategory": "Understanding the tool",
     ...
     "expected_keywords": ["research", "responsible ai"]},
    ...
    {"id": "S19", "profile": "Students", "subcategory": "Basic concepts",
     "query": "What is the difference between AI ethics and responsible AI?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["ethics", "responsible"]},

    {"id": "S20", "profile": "Students", "subcategory": "Basic concepts",
     "query": "Can AI make decisions on its own?",
     "expected_behavior": "answer", "expected_banner": None,
     "expected_keywords": ["autonom", "decision"]},
    ...
    {"id": "S22", "profile": "Students", "subcategory": "Coursework",
     ...
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["trustworthy"]},

    {"id": "S23", "profile": "Students", "subcategory": "Coursework",
     "query": "What is the difference between interpretability and explainability?",
     "expected_behavior": "answer", "expected_banner": None,
     "expected_keywords": ["interpretab", "explainab"]},

    {"id": "S24", "profile": "Students", "subcategory": "Coursework",
     "query": "Is XAI related to transparency?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["XAI", "transparen"]},

    {"id": "S25", "profile": "Students", "subcategory": "Coursework",
     "query": "What is data sovereignty?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["data sovereignty"]},

    {"id": "S26", "profile": "Students", "subcategory": "Coursework",
     "query": "What is sustainable AI?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["sustainab"]},

    {"id": "S27", "profile": "Students", "subcategory": "Coursework",
     "query": "What is algorithmic auditing?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["audit"]},

    {"id": "S28", "profile": "Students", "subcategory": "Coursework",
     "query": "What are the OECD AI principles?",
     "expected_behavior": "answer", "expected_banner": BANNER_YELLOW,
     "expected_keywords": ["OECD"]},

    {"id": "S29", "profile": "Students", "subcategory": "Coursework",
     "query": "Is AI used in healthcare? What are the risks?",
     "expected_behavior": "answer", "expected_banner": None,
     "expected_keywords": ["healthcare", "risk"]},
    ...
    {"id": "S32", "profile": "Students", "subcategory": "Coursework",
     "query": "What is privacy and data governance in AI?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["privacy", "data"]},

    {"id": "S33", "profile": "Students", "subcategory": "Coursework",
     "query": "Can you help me with my homework on AI ethics?",
     "expected_behavior": "answer", "expected_banner": None,
     "expected_keywords": ["ethics"]},

    {"id": "S34", "profile": "Students", "subcategory": "Coursework",
     "query": "Write me a summary of responsible AI for my essay",
     "expected_behavior": "answer", "expected_banner": None,
     "expected_keywords": ["responsible"]},

    {"id": "S35", "profile": "Students", "subcategory": "Coursework",
     "query": "What are the main responsible AI topics?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
    ...
    {"id": "S40", "profile": "Students", "subcategory": "Off-topic",
     "query": 'Translate this text to French: "Responsible AI is important"',
     "expected_behavior": "refuse", "expected_banner": BANNER_RED,
     "expected_keywords": []},
    ...
    {"id": "P04", "profile": "Professors", "subcategory": "Publications",
     "query": "List papers from UMA on convolutional neural networks",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
    ...
    {"id": "P05", "profile": "Professors", "subcategory": "Publications",
     ...
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["privacy"]},

    {"id": "P06", "profile": "Professors", "subcategory": "Publications",
     "query": "Research on AI in education within UNINOVIS",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["education"]},

    {"id": "P07", "profile": "Professors", "subcategory": "Publications",
     "query": "Studies on AI-driven decision support systems",
     "expected_behavior": "answer", "expected_banner": None,
     "expected_keywords": ["decision"]},

    {"id": "P08", "profile": "Professors", "subcategory": "Publications",
     "query": "Papers on recommender systems and fairness",
     "expected_behavior": "answer", "expected_banner": None,
     "expected_keywords": ["recommender"]},

    {"id": "P09", "profile": "Professors", "subcategory": "Publications",
     "query": "Research on robotics and the EU AI Act",
     "expected_behavior": "answer", "expected_banner": None,
     "expected_keywords": ["robot"]},
    ...
    {"id": "P11", "profile": "Professors", "subcategory": "Researchers",
     ...
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["THUAS"]},

    {"id": "P12", "profile": "Professors", "subcategory": "Researchers",
     "query": "List researchers working on explainable AI",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["explainable"]},

    {"id": "P13", "profile": "Professors", "subcategory": "Researchers",
     "query": "Which researchers work on federated learning?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
    ...
    {"id": "P15", "profile": "Professors", "subcategory": "Researchers",
     "query": "What has Fabrizio Esposito published?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
    ...
    {"id": "P16", "profile": "Professors", "subcategory": "Researchers",
     ...
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["González"]},

    {"id": "P17", "profile": "Professors", "subcategory": "Researchers",
     "query": "What are the research interests of Frank-Michael Schleif?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["Schleif"]},
    ...
    {"id": "P21", "profile": "Professors", "subcategory": "Projects",
     ...
     "expected_behavior": "answer", "expected_banner": BANNER_YELLOW,
     "expected_keywords": ["TAILOR", "trustworthy"]},
    ...
    {"id": "P31", "profile": "Professors", "subcategory": "Collaboration",
     "query": "Which partners have joint publications on AI transparency?",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["transparen"]},
    ...
    {"id": "P37", "profile": "Professors", "subcategory": "Collaboration",
     "query": "Compare the research focus of THUAS and THWS",
     "expected_behavior": "answer", "expected_banner": BANNER_YELLOW,
     "expected_keywords": ["THUAS", "THWS"]},
    ...
    {"id": "P39", "profile": "Professors", "subcategory": "Figures",
     "query": "Show a figure of studies on the topic AI and Ethics",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["figure", "iframe"]},
    ...
    {"id": "P43", "profile": "Professors", "subcategory": "Figures",
     "query": "Show a map of publications on trustworthy AI",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["map", "iframe"]},
    ...
    {"id": "A07", "profile": "Admin", "subcategory": "Reporting",
     "query": "Show a map of researchers working on explainable AI",
     "expected_behavior": "answer", "expected_banner": BANNER_GREEN,
     "expected_keywords": ["map", "iframe"]},
...
def main():
    parser = argparse.ArgumentParser(
        description="Benchmark 100 queries for the Responsible AI Agent",
...
""")
    ...
    parser.add_argument("--agent", default="responsible_ai3", help="Agent ID (default: responsible_ai3)")
