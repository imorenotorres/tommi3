...
- Questions about ANY AI or responsible AI topic (even if not in the database) should be general, NOT off_topic.
...
class Agent(VectorlessMixin, MetadataRAGMixin, BaseRAGAgent):
    ...
    def _build_meta_response(self) -> str:
        ...
        return (
            ...
            f"2. **Documents database** — PDF papers, funded research projects, and a glossary of Responsible AI concepts, selected by UNINOVIS staff.\n"
