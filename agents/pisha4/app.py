"""
Pisha4 - Servidor FastAPI (Text-to-SQL with SQL verification)
"""
...
# Ensure 'id' key exists for API compatibility
AGENT_CONFIG.setdefault("id", AGENT_CONFIG.get("agent_id", "pisha4"))
